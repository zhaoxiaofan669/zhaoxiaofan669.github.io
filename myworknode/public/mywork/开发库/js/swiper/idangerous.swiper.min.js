			...
			C.callPlugins = function(a, b) {
				...
				if (d !== C.width || e !== C.height || a) {
					...
					if (a && C.calcSlides(c), "auto" === b.slidesPerView) {
						...
						b.centeredSlides && 
						(M ? (C.wrapperLeft = (I - this.slides[0].getWidth(!0, b.roundLengths)) / 2,
						...
						C.wrapperBottom = (I - C.slides[C.slides.length - 1].getHeight(!0, b.roundLengths)) / 2)), M ? (C.wrapperLeft >= 0 && (m.style.paddingLeft = C.wrapperLeft + "px"),
						C.wrapperRight >= 0 && (m.style.paddingRight = C.wrapperRight + "px")) : (C.wrapperTop >= 0 && (m.style.paddingTop = 0 + "px"), C.wrapperBottom >= 0 && 
						(m.style.paddingBottom = C.wrapperBottom + "px")), k = 0;
						//alert(I - C.slides[C.slides.length - 1].getHeight(!0, b.roundLengths));
